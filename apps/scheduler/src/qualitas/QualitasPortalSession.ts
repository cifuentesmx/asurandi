...
import { handleDailyScrap } from "../pg-service/handleDailyScrap.js"
...
import { updateAll } from "../pg-service/updateAll.js"
// import { getQualitasDecenas } from "./getQualitasDecenas"
export class QualitasPortalSession {
    ...
    public async updatePoliza(numero_poliza: string): ReturnType<typeof updatePoliza> {
